...
Be sure to look over the [installation docs](../../../webup/docs/install.md) to verify your environment is prepared to run WSK.
Once you have verified that your system can run WSK, check out the [commands](../../../webup/docs/commands.md) available to get started.
